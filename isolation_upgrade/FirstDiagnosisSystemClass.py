...
class ExampleDiagnosisSystem(DiagnosisSystemClass):
    ...
    def Initialize(self):
        ...
        self.model0.eval()
        self.scaler_u0 = joblib.load(os.path.join('params', 'scaler_u_mso0.pkl'))
        self.scaler_y0 = joblib.load(os.path.join('params', 'scaler_y_mso0.pkl'))
        ...
        self.model10.eval()
        self.scaler_u10 = joblib.load(os.path.join('params', 'scaler_u_mso10.pkl'))
        self.scaler_y10 = joblib.load(os.path.join('params', 'scaler_y_mso10.pkl'))
        ...
        self.model1.eval()
        self.scaler_u1 = joblib.load(os.path.join('params', 'scaler_u_mso1.pkl'))
        self.scaler_y1 = joblib.load(os.path.join('params', 'scaler_y_mso1.pkl'))
        ...
        self.modelwaf.eval()
        self.scaler_uwaf = joblib.load(os.path.join('params', 'scaler_u_waf.pkl'))
        self.scaler_ywaf = joblib.load(os.path.join('params', 'scaler_y_waf.pkl'))
